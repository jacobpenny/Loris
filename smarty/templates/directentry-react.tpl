...
<body>
    <div data-instrument="{$instrumentJSON}" data-initial="{$initialData}" data-lang="{$lang}" data-context="{$context}" data-logo="{$logo}" data-study="{$study}" data-agewindows="{$agewindows}" id="instrument"></div>
